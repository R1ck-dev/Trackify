...
public class MediaController {
    ...
    public ResponseEntity<Void> deleteMediaEntry(@PathVariable String mediaId, Authentication authentication) {
        mediaService.deleteMediaEntry(mediaId, authentication);
